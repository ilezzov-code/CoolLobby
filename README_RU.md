...
- [Описание](#a-idaboutописаниеa)
- [Особенности](#a-idfeaturesособенностиa)
- [Config.yml](#a-idconfigconfigymla)
- [Команды](#a-idcommandsкоманды-команда--псевдоним1-псевдоним2---правоa)
- [Двойной прыжок](#double-jump)
- [Права](#все-права-плагина)
- [Синхронизация с несколькими мирами](#a-idsyncсинхронизация-с-несколькими-мирами-a)
- [Система нескольких спавнов](#a-idspawn-systemсистема-нескольких-спавновa)
- [Галерея](#a-idpicturesгалереяa)
...
* **[🔥] Синхронизация с несколькими мирами** → [подробнее](#a-idsyncсинхронизация-с-несколькими-мирами-a)
...
* 5 полезных и интересных команд → [подробнее](#a-idcommandsкоманды-команда--псевдоним1-псевдоним2---правоa)
* Система нескольких спавнов
* Сообщение при входе и выходе игрока
    * Title при входе игрока
    * Звук при вхоже игрока
* Телепортация на спавн при входе
* Двойной прыжок: → [подробнее](#double-jump)
...
## Двойной прыжок ※ `coollobby.double_jump`

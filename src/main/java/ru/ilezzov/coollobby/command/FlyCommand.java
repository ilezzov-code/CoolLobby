...
public class FlyCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull final CommandSender sender, @NotNull final Command command, @NotNull final String s, final @NotNull String[] strings) {
        ...
        if (Main.getApi().setFly(player)) {
            sender.sendMessage(PluginMessages.commandFlyEnableCommandMessage(commandPlaceholders));
        } else {
            sender.sendMessage(PluginMessages.commandFlyDisableCommandMessage(commandPlaceholders));
        }
